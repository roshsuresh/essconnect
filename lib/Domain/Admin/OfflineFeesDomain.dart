...
class OfflineFeeView {
  ...
  OfflineFeeView.fromJson(Map<String, dynamic> json) {
    ...
    pagination = json['pagination'] != null
        ? new PaginationFee.fromJson(json['pagination'])
        : null;
...
class PaginationFee {
  ...
  PaginationFee({this.currentPage, this.pageSize, this.count});

  PaginationFee.fromJson(Map<String, dynamic> json) {
...
class BusFee {
  ...
  BusFee.fromJson(Map<String, dynamic> json) {
    ...
    pagination = json['pagination'] != null
        ? new PaginationBus.fromJson(json['pagination'])
        : null;
    if (json['exportList'] != null) {
...
class PaginationBus {
  ...
  PaginationBus({this.currentPage, this.pageSize, this.count});

  PaginationBus.fromJson(Map<String, dynamic> json) {
    currentPage = json['currentPage'];
    pageSize = json['pageSize'];
    count = json['count'];
  }
