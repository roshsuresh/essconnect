class BillDeskData {
  ...
  BillDeskData(
      {this.errorType,
        ...
        this.links,
        this.status,
        this.loadScriptBaseUrl});

  BillDeskData.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status'];
    loadScriptBaseUrl = json['loadScriptBaseUrl'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['status'] = status;
    data['loadScriptBaseUrl'] = loadScriptBaseUrl;
    return data;
  }
}
