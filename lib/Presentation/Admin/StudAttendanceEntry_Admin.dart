...
class AttendenceEntry_Admin extends StatefulWidget {
  AttendenceEntry_Admin({Key? key}) : super(key: key);

  @override
  State<AttendenceEntry_Admin> createState() => _AttendenceEntry_AdminState();
}

class _AttendenceEntry_AdminState extends State<AttendenceEntry_Admin> {
  String? forattd;
  String? aftattd;
  // DateTime? curdate;
  // String? newdate;
            ...
            IconButton(
                onPressed: () {
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>  AttendenceEntry_Admin()));
                },
                                  ...
                                  return ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      if (value.studentsAttendenceView
                                          .isNotEmpty&&value.studentsAttendenceView[0].studAttId==null) {
                              ...
                              MaterialButton(
                                onPressed: value.loading
                                  ...
                                  if (markEntryDivisionListController
                                    ...
                                    value.smsLinkAttendance==true? await  showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: const Center(
