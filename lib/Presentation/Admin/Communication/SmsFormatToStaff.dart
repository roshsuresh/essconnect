...
class _SmsFormatToStaffState extends State<SmsFormatToStaff> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      var p = Provider.of<NotificationToStaffAdminProviders>(context, listen: false);
        ...
        body: ListView(
          children: [
                                  ...
                                  return Dialog(
                                      child: LimitedBox(
                                        ...
                                        child: ListView.builder(
                                            shrinkWrap: true,
                                            itemCount: snapshot.formatlists.isEmpty
                                                ? 0
                                              ...
                                              return ListTile(
                                                onTap: () async {
                                                  ...
                                                  provcheck = snapshot
                                                      ...
                                                      .isApproved!;
                                                 // print("-------");
                                                  print(snapshot.formatlists[index].name);
                                                 // formatController1.clear();
                                                  ...
                                                  formatController1.text =
                                                      await snapshot
                                                          ...
                                                          .name ??
                                                          '--';
                                                  await snapshot.getStaffSMSContent(
                                                      formatController.text);

                                                  Navigator.of(context).pop();
                                                },
                                                title: Text(
                                                  snapshot.formatlists[index].name ??
                                                      '--',
            ...
            Consumer<NotificationToStaffAdminProviders>(
              builder: (context, value, child) => value.smsBody==null || value.smsBody==""
                  ? Container(
                height: 0,
                width: 0,
              )
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (formatController1.text.isEmpty) {
                                      ...
                                      if (provcheck == true) {
                                        ...
                                        await value.sendSmstoStaff(context, formatController.text.toString());
                                       value.staffSmsList.clear();
                                        // formatController1.clear();
