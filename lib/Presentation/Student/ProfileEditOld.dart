                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (pickedImage != null)
                                                                      {
                                                                        ...
                                                                        croppedFile = await ImageCropper().cropImage(
                                                                          ...
                                                                          //     ratioX: 350, ratioY: 275),
                                                                          uiSettings: [
                                                                            AndroidUiSettings(

                                                                              toolbarTitle: 'Cropper',
                                                                              toolbarColor: UIGuide.light_Purple,
                                                                        ...
                                                                        int sizee= File(croppedFile!.path).lengthSync();
                                                                        print("sizeeeeeeeeeeee  $sizee");
                                                                        ...
                                                                        if (sizee <=
                                                                          ...
                                                                          ScaffoldMessenger.of(context)
                                                                            ...
                                                                            content:
                                                                            Text(
                                                                              "Size Exceed(Less than 200KB allowed)$sizee",
                                                                              textAlign:
                                                                              TextAlign.center,
                                                                            ),
                                                                          ));
