                              ...
                              return Dialog(
                                  ...
                                  child: LimitedBox(
                                    ...
                                    child: ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: snapshot
                                            .remarksEntryInitialValues.length,
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: (() async {
                            ...
                            String course = remarkEntryInitialValuesController
                                .text
                                .toString();
                            String division = remarkEntryDivisionListController
                                .text
                                .toString();
                            String category =
                      ...
                      itemBuilder: ((context, index) {
                        ...
                        _controllers[index].text.isEmpty
                            ? _controllers[index].text =
                                provider.studListRemarks[index].remarks == null
                                    ? _controllers[index].text
                        ...
                        remarkListController[index].text.isEmpty
                            ? remarkListController[index].text = provider
                                ...
                                : provider.studListRemarks[index].remarksCaption
                                    .toString()
                            : remarkListController[index].text;
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      provider.studListRemarks[index].rollNo ==
                                              null
                                          ? const Text(
                                              '',
                                              style: TextStyle(
                                                              ...
                                                              ListView.builder(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return ListTile(
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        remarkListController[index]
                                                                            .text = snapshot
                                                                                .remarksMaster[indx].text ??
                                                                            '--';
                                                                        remarkListController1[index]
                                                                            .text = snapshot
                                                                                .remarksMaster[indx].value ??
                                                                            '--';
                                                                        provider
                                                                            .studListRemarks[
                                                                                index]
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: ((context, index) {
                        ...
                        principalremarkController.add(TextEditingController());
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                          ...
                                          child: Text(
                                        provider.studListRemarks[index].name ??
                                            "-",
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 1,
                                        style: const TextStyle(
                                  ...
                                  if (value.tabmethod == "UAS") {
                                    for (int i = 0;
                                      ...
                                      obj.add(
                                        {
                                          "rollNo":
                                              value.studListRemarks[i].rollNo,
                                          "studentId": value
                                              .studListRemarks[i].studentId,
                                          "name": value.studListRemarks[i].name,
                                          "remarks": _controllers[i]
                                                  .text
                                                  .isEmpty
                                              ? null
                                    ...
                                    for (int i = 0;
                                      ...
                                      obj.add(
                                        {
                                          ...
                                          "studentId": value
                                              .studListRemarks[i].studentId,
                                          "name": value.studListRemarks[i].name,
                                          "remarks": teacherremarkController[i]
                                                  .text
                                                  .isEmpty
                                              ? null
                                      ...
                                      remarrkk.add(teacherremarkController[i]
                                          .text
                                          .toString());
