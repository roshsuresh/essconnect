...
class _RemarksEntryState extends State<RemarksEntry> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      p.setLoading(false);
      await p.getRemarkEntryInitialValues();
    });
  }
                          ...
                          builder: (context) {
                            return Dialog(
                              ...
                              child: ListView.builder(
                                  shrinkWrap: true,
                                  itemCount:
                                      snapshot.remarksEntryInitialValues.length,
                                      ...
                                      onTap: () async {
                                        ...
                                        courseId =
                                            remarkEntryInitialValuesController
                                                ...
                                                .toString();
                                        instaId = snapshot
                                            .remarksEntryInitialValues[index]
                                            .installationId
                                            .toString();
                                        ...
                                        remarkEntryCategoryController.clear();
                                        remarkEntryCategoryController1.clear();
                                        ...
                                        await snapshot.removeAllTermClear();
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextField(
                              textAlign: TextAlign.center,
                              controller: remarkEntryInitialValuesController,
                              decoration: const InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 238, 237, 237),
                                border: OutlineInputBorder(),
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(
                            height: 0,
                            child: TextField(
                              controller: remarkEntryDivisionListController,
                              decoration: const InputDecoration(
                                filled: true,
                                fillColor: Color.fromARGB(255, 238, 237, 237),
                                border: OutlineInputBorder(),
                                    ...
                                    child: Dialog(
                                      ...
                                      children: [
                                        ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              print(snapshot.remarkterm.length);
                                              return ListTile(
                                                selectedTileColor:
                                                    Colors.blue.shade100,
                                                selectedColor: UIGuide.PRIMARY2,
          ...
          Row(
            children: [
              ...
              Consumer<RemarksEntryProvider>(
                builder: (context, snapshot, child) {
                  if (remarkEntryCategoryController1.text != "Assessment") {
                    return Container(
                      height: 0,
                      width: 0,
                    );
                                  ...
                                  children: [
                                    ListView.builder(
                                        ...
                                        itemCount: snapshot
                                                ...
                                                .isEmpty
                                            ? 0
                                            : snapshot.remarkEntryAssessmentList
                                                .length,
                                        itemBuilder: (context, index) {
                                          return ListTile(
                                            selectedTileColor:
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: const Text(
                            ...
                            style:
                                TextStyle(color: UIGuide.BLACK, fontSize: 12),
                          ),
                        )
                      ],
                    )),
                  ...
                  : Expanded(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: (() async {
                          ...
                          String course = remarkEntryInitialValuesController
                              .text
                              .toString();
                          String division =
                              remarkEntryDivisionListController.text.toString();
                          String category =
                              remarkEntryCategoryController1.text.toString();
                          ...
                          if (value.tabmethod == "UAS") {
                            ...
                            if (courseId.isEmpty ||
                              ...
                              await value.getRemarksEntryView(
                                  ...
                                  categoryId,
                                  termId,
                                  category == "Assessment" ? assessmentId : "",
                                  value.isTerminated,
                                  false,
                                  true,
                                  value.tabmethod.toString());
                                                              ...
                                                              return ListTile(
                                                                ...
                                                                onTap: () {
                                                                  ...
                                                                  provider
                                                                      .studListRemarks[
                                                                          index]
                                                                      .remarksMasterId = remarkListController1[
                                                                          index]
                                                                      .text;
              ...
              return LimitedBox(
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                        ...
                        itemCount: provider.studListRemarks.length,
                        itemBuilder: ((context, index) {
                          teacherremarkController.add(TextEditingController());
                          ...
                          print(value.studListRemarks[index].principalRemarks);
                ...
                return value.loadSave
                    ...
                    : MaterialButton(
                        onPressed: () async {
                          ...
                          try {
                            if (value.tabmethod == "UAS") {
                              for (int i = 0;
                                ...
                                obj.add(
                                  {
                                    "rollNo": value.studListRemarks[i].rollNo,
                                    "studentId":
                                        value.studListRemarks[i].studentId,
                                    "name": value.studListRemarks[i].name,
                                    "remarks": _controllers[i].text.isEmpty
                                        ? null
                                        : _controllers[i].text.toString(),
                                    "principalRemarks": null,
                                    "remarksMasterId": value
                                        .studListRemarks[i].remarksMasterId,
                                    "fileId": null,
                                    // "remarksCaption": value.studListRemarks[i].remarksCaption,
                                    "remarksEntryId":
                                        value.studListRemarks[i].remarksEntryId,
                                    "remarksEntryDetId": value
                                        .studListRemarks[i].remarksEntryDetId
                                  },
                                );
                                remarrkk.add(_controllers[i].text.toString());
                                print(obj);
                                print("""""" """""" "");
                              }
                              ...
                              for (int i = 0;
                                ...
                                obj.add(
                                  {
                                    ...
                                    "name": value.studListRemarks[i].name,
                                    "remarks":
                                        teacherremarkController[i].text.isEmpty
                                            ? null
                                ...
                                remarrkk.add(
                                    teacherremarkController[i].text.toString());
                          ...
                          if (remarkEntryDivisionListController.text.isEmpty &&
                              remarkEntryInitialValuesController.text.isEmpty) {
                            ScaffoldMessenger.of(context)
                                .showSnackBar(const SnackBar(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
                            ...
                            value.loadSave
                                ...
                                : await value.remarkEntrySave(
                                    ...
                                    assessmentId,
                                    value.isTerminated,
                                    category == "Assessment" ? true : false,
                                    category == "Final" ? false : true,
                                    value.tabmethod.toString(),
                                    context,
                                    obj,
                                  );
                              ...
                              children: [
                                ...
                                OutlinedButton(
                                      ...
                                      value.loadDelete
                                          ...
                                          : await value.remarkEntryDelete(
                                              ...
                                              remarkEntryDivisionListController.text
                                                  .toString(),
                                              remarkEntryCategoryController.text
                                                  .toString(),
                                              remarkEntryTermController1.text
                                                  .toString(),
                                              remarkEntryAssessmentListController1
                                                  .text
                                                  .toString(),
                                  ...
                                  child: const Text(
                                    'Confirm',
                                    style: TextStyle(
                                      color: Color.fromARGB(255, 12, 162, 46),
                                    ),
                                  ),
                                ),
                              ],
