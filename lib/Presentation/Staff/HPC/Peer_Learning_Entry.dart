...
class PeerLearningEntry extends StatefulWidget {
  const PeerLearningEntry({super.key});

  @override
  State<PeerLearningEntry> createState() => _PeerLearningEntryState();
}

class _PeerLearningEntryState extends State<PeerLearningEntry> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      var c = Provider.of<HPC_PeerLearning_Provider>(context, listen: false);
      c.stagelist.clear();
      c.courselist.clear();
      c.partlist.clear();
      ...
      await c.stagelistPeerfn(context);

    });
  }
  void _reset() {
    var provider = Provider.of<HPC_PeerLearning_Provider>(context, listen: false);
    setState(() {
      selectedStage = null;
      selectedCourse = null;
      selectedDomain = null;
  ...
  Widget build(BuildContext context) {
    ...
    var provider = Provider.of<HPC_PeerLearning_Provider>(context);
    return  Scaffold(
      appBar: AppBar(
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          onChanged: (value) async {
                            ...
                            provider.partlist.clear();
                            print(stageValue);
                            await provider.courselistPeerfn(context, stageValue);
                          },
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Peer Learning Entry Downloaded",style: TextStyle(
                    ...
                    SizedBox(
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            // Create a list of student entries
                            ...
                            // Collect names of students who do not have a peer student selected
                            ...
                            if (studentEntries.isEmpty || hasAnyChange == false) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('No change in peer learning entry'),
