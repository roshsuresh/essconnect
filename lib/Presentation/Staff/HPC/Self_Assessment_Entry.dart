...
class SelfAssessmentEntry extends StatefulWidget {
  const SelfAssessmentEntry({super.key});

  @override
  State<SelfAssessmentEntry> createState() => _SelfAssessmentEntryState();
}

class _SelfAssessmentEntryState extends State<SelfAssessmentEntry> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      var c = Provider.of<HPC_SelfAssessment_Provider>(context, listen: false);
      c.stagelist.clear();
      c.courselist.clear();
      c.partlist.clear();
  ...
  void _reset() {
    var provider = Provider.of<HPC_SelfAssessment_Provider>(context, listen: false);
    setState(() {
      selectedStage = null;
      selectedCourse = null;
      selectedDomain = null;
  ...
  Widget build(BuildContext context) {
    ...
    var provider = Provider.of<HPC_SelfAssessment_Provider>(context);
    return  Scaffold(
      appBar: AppBar(
                        ...
                        child: Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                // Access the list of statements for the current student
                                                        ...
                                                        child: SizedBox(
                                                          ...
                                                          child: Wrap(
                                                            ...
                                                            children: List.generate(provider.statementList.length, (ind) {
                                                              ...
                                                              // Pre-select the value based on studentAbility responseLevelId
                                                              ...
                                                              return SizedBox(
                                                                ...
                                                                child:  // Initialize with "--select--" by default

                                                               // Set default value to "--select--"

                                                                CustomDropdownsButtonFormField(
                                                                  value: selectedAbilityResponse ?? '--Select--', // Use "--select--" if selectedAbilityResponse is null
                                                                  ...
                                                                  onChanged: (value) {
                                                                    setState(() {
                                                                      selectedAbilityResponse = value == '--select--' ? null : value; // Set null if "--select--" is chosen
                                                                      provider.studententrieslist[index].isEdited = true; // Mark as edited for any change

                                                                      if (value != '--Select--') {
                                                                        // Update responseLevelId when a valid option is selected
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("Self Assessment Entry Downloaded",style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                        ...
                        onPressed: () async {
                          ...
                          List<Map<String, dynamic>> studentEntries = provider.studententrieslist
                            ...
                            return {
                              ...
                              "studentStatements": student.studentStatements.map((ability) {
                                ...
                                return {
                                  "responseLevelId": ability.responseLevelId==null||
                                      ability.responseLevelId==""?null:
                          ...
                          if(studentEntries.isEmpty || hasAnyChange==false) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                    'No change in self assessment entry'),
                                duration: Duration(seconds: 2),
                              ),
                            );
                          }
                          else {
                            await provider.saveSelfAssessmentEntry(
                              context,
                              stage,
                              course,
                              domain,
                    ...
                    if (provider.selfassessmententry?.entryStatus == "Entered") ...[
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            try {
                              await provider.verifySelfAssesmentEntry(
                                context,
                                stage,
                                course,
                                domain,
                      ...
                      return {
                      "responseLevelId": ability.responseLevelId == null || ability.responseLevelId == ""
                      ? null
                          : ability.responseLevelId.toString(),
                      "statementId": ability.statementId,
                      "statementName": ability.statementName,
                      ...
                      await provider.deleteSelfAssessmentEntry(
                      context,
                      stage,
                      course,
                      domain,
