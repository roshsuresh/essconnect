        ...
        return value.load
          ...
          onWillPop: () async {
            if (value.studentsAttendenceView.isNotEmpty) {
              print("iddddd");
              print(value.studentsAttendenceView[0].studAttId);
              if (value.studentsAttendenceView[0].studAttId == null) {
                print("iddddd");
                ...
                // Pop the screen if id is not empty
                return true;
              }
            } else {
              return true;
                            ...
                            child: value.loading
                                ...
                                onPressed: () async {
                                  ...
                                  if (value.dateSend.isEmpty) {
                                    ...
                                    await value
                                        .getstudentsAttendenceView(context,
                                        value.dateSend,
                                        divisionId);
                                  }
                                }),
                                                  ...
                                                  children: [
                                                    ...
                                                    TableCell(
                                                      ...
                                                      InkWell(
                                                        onTap:
                                                            () async {
                                                          if(value.attandance_disable==false){
                                                            setState(
                                                                    () {
                  ...
                  children: [
                    ...
                    Consumer<AttendenceStaffProvider>(
                        ...
                        value.studentsAttendenceView[0].studAttId ==
                          ...
                          child: const Text(
                            ...
                            style: TextStyle(
                              color: UIGuide.light_Purple,fontSize: 12
                            ),
                          ),
                        )),
                    const Spacer(),
                    SizedBox(
                      ...
                      child: Consumer<AttendenceStaffProvider>(
                          builder: (context, value, child) {
                            return
                              // value.attandance_disable==false?SizedBox(width: 0,height: 0,):
                              AbsorbPointer(
                                absorbing: value.attandance_disable==true?true:false,
                                child: MaterialButton(
                                  onPressed: value.loading
                                    ...
                                    if (markEntryDivisionListController
                                                  ...
                                                  OutlinedButton(
                                                    onPressed:
                                                      ...
                                                      await Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                              builder: (context) => AbsenteesReportDirectStaff(
                                                                course:
                                                                courseId,
                                                                division:
                                                                divisionId,
                                      ...
                                      await value.getstudentsAttendenceView(context,
                                          value.dateSend, divisionId);
                                    }
                                  },
                                  color: value.attandance_disable==false?UIGuide.light_Purple:Colors.grey,
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(10.0),
                                  ),
                                  child: const Text(
                            ...
                            return
                              ...
                              AbsorbPointer(
                                ...
                                child: MaterialButton(
                                  ...
                                  color: value.attandance_disable==false?Colors.red:Colors.grey,
                                  child: const Text(
                                    'Delete',
                                    style: TextStyle(color: Colors.white),
                                  ),
