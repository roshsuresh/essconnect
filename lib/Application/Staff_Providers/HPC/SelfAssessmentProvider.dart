...
class HPC_SelfAssessment_Provider with ChangeNotifier {
...
String bearer ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..ED9uQjj7eZS7CB1nCoBluP0vnc3m6_VQiuET5lWi8Yc";
  ...
  List<StudentEntriesSelfAssessment> studententrieslist = [];
  AssessmentEntries? selfassessmententry;
...
String? assessmentTypeName;
  ...
  Future<void> stagelistfn(BuildContext context) async {
    ...
    var response = await http.get(
      Uri.parse(
          '${UIGuide.baseURL}/hpc-assessment-entry/initialvalues/Self-Assessment'),
      headers: headers,
    );
  ...
  Future<void> courselistfn(BuildContext context, String stageValue) async {
    ...
    var response = await http.get(
      Uri.parse(
          '${UIGuide.baseURL}/hpc-assessment-entry/stage-change/$stageValue/Self-Assessment'),
      headers: headers,
    );
    // Log the raw response body to inspect its structure
    log(response.body.toString());
  ...
  Future<void> viewfn(
   ...
   print("selfbodyyyyyyyyyyyyy");
    ...
    if (response.statusCode == 200) {
      ...
      selfassessmententry = AssessmentEntries.fromJson(data['assessmentEntry']);
      // Parsing student entries
      List<StudentEntriesSelfAssessment> templist9 = List<StudentEntriesSelfAssessment>.from(
          data['assessmentEntry']["studentEntries"].map((x) => StudentEntriesSelfAssessment.fromJson(x))
      );
  ...
  Future<void> saveSelfAssessmentEntry(BuildContext context,String stage,String course,
  ...
  Future<void> verifySelfAssesmentEntry(BuildContext context,String stage,String course,
      String domain,String activity,
      String part,String division,
      String courseDomain,List studentEntriesList,
      String date,
...
//---------Delete--------------
  ...
  Future<void> deleteSelfAssessmentEntry(BuildContext context,String stage,String course,
      String domain,String activity,
      String part,String division,
      String courseDomain,List studentEntriesList,
      String date,
