...
class OffflineFeesProvider with ChangeNotifier{
 ...
 List<OfflineCourse> courseList= [];
  ...
  Future getFeeCollectionReport(BuildContext context,String courseId, String divId, String fromDate,toDate) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    var headers = {
      'Content-Type': 'application/json',
    ...
    var response = await http.get(
        Uri.parse(
            "${UIGuide.baseURL}/fee-col-summary/genFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=1"),
        headers: headers);
    print(Uri.parse(
        "${UIGuide.baseURL}/fee-col-summary/genFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=1"));
    if (response.statusCode == 200) {
      ...
      netAmount =res.netAmount.toString();
      ...
      PaginationFee pagenata =
      PaginationFee.fromJson(data['pagination']);
  ...
  Future getFeeCollectionPagination(String courseId, String divId, String fromDate,toDate) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    var headers = {
      'Content-Type': 'application/json',
    ...
    var response = await http.get(
        Uri.parse(
            "${UIGuide.baseURL}/fee-col-summary/genFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=$currentPage"),
        headers: headers);
    print(Uri.parse(
        "${UIGuide.baseURL}/fee-col-summary/genFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=$currentPage"));
    if (response.statusCode == 200) {
      ...
      collectionlList.addAll(templist2);
        ...
        setLoading(false);
        print('Error in fees collection list');
      }
  ...
  bool hasMoreData() {
    ...
    notifyListeners();
    return collectionlList.length < totalCount!;
  }
  ...
  Future getBusFeeCollectionReport(BuildContext context,String courseId, String divId, String fromDate,toDate) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    var headers = {
      'Content-Type': 'application/json',
    ...
    var response = await http.get(
        Uri.parse(
            "${UIGuide.baseURL}/fee-col-summary/busFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=1"),
        headers: headers);
    print(Uri.parse(
        "${UIGuide.baseURL}/fee-col-summary/busFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=1"));
    if (response.statusCode == 200) {
      ...
      netAmountBus=res.netAmount.toString();
      if(buscollectionlList.isNotEmpty) {
        DateTime dateTime = DateTime.parse(res.uploadedDate.toString());
        uploadedBusDate = DateFormat('dd-MM-yyyy').format(dateTime);
      }
      PaginationBus pagenata =
      PaginationBus.fromJson(data['pagination']);
      pageSize = pagenata.pageSize;
      countStud = pagenata.count;
      print(pageSize);
      print(countStud);
  ...
  Future getBusFeeCollectionPagination(String courseId, String divId, String fromDate,toDate) async {
    SharedPreferences _pref = await SharedPreferences.getInstance();
    setLoading(true);
    var headers = {
      'Content-Type': 'application/json',
    ...
    var response = await http.get(
        Uri.parse(
            "${UIGuide.baseURL}/fee-col-summary/busFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=$currentPage"),
        headers: headers);
    print(Uri.parse(
        "${UIGuide.baseURL}/fee-col-summary/busFeesSummary/?courses=$courseId&divisions=$divId&fromDate=$fromDate&toDate=$toDate&page=$currentPage"));
    if (response.statusCode == 200) {
  ...
  bool hasMorBuseData() {
    final totalCount = countStud;
    notifyListeners();
    return buscollectionlList.length < totalCount!;
  }
